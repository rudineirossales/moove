    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="tile">
          <form class="form-inline" role="form"   method="POST" action="pesq_vistoria_encerradas.php" style="margin-left:10%;">
          ...
          <div class="table-responsive">  
                     <table id="myTable" class="table table-striped table-bordered">  
                          ...
                          <?php  
                            ...
                            $query ="select *  from pos_ba  where data BETWEEN '$data' and '$data2' and status ='VISTORIADO' ";
