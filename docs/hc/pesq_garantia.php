...
function fnExcelReport() {
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Pesquisa de garantia justificados</h1>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="tile">
          <form class="form-inline" role="form"   method="POST" action="pesq_garantia.php" style="margin-left:10%;">
          ...
          <div class="table-responsive">  
                     <table id="myTable" class="table table-striped table-bordered">  
                          ...
                          <?php  
                           ...
                           $query ="select *  from garantia where data_referencia BETWEEN '$data' and '$data2' and status = 'JUSTIFICADO'";
                          ...
                          {     
                               ...
                               <td><a style='padding-left:25%;' target="_blank" href='pdf_garantia.php?sa=<?php echo $sa; ?>'><i class='icon fa fa-folder-open-o'></i></a></td>
