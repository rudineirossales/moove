                     ...
                     <table id="myTable" class="table table-striped table-bordered">  
                          <thead>  
                               <tr> 
                                    ...
                                    <td>Atendeu 2º?</td>
                                    <td>Potencia 2º</td> 
                                    <td>Funcionalidade 2º</td>
                                    <td>Nome triagem 2º</td>
                                    <td>Data triagem 2º</td> 
                                    <td>Descricao triagem 2º</td> 

                                    <td>Atendeu 3º?</td> 
                                    <td>Potencia 3º</td> 
                                    <td>Funcionalidade 3º</td>
                                    <td>Nome triagem 3º</td>
                                    <td>Data triagem 3º</td> 
                                    <td>Descricao triagem 3º</td> 

                                    <td>Atendeu 4º?</td>
                                    <td>Potencia 4º</td> 
                                    <td>Funcionalidade 4º</td>
                          ...
                          <?php  
                            ...
                            $query ="select *  from reparo_hc where data_execucao BETWEEN '$data' and '$data2'";  
                          ...
                          {     
                               ...
                               <td>'.$row["atendeu_2"].'</td>  
                               <td>'.$row["potencia_2"].'</td>
                               <td>'.$row["funcionalidade_2"].'</td>
                               <td>'.$row["contato2"].'</td>
                               <td>'.$row["data_contato2"].'</td>
                               <td>'.$row["obs_contato2"].'</td>

                               <td>'.$row["atendeu_3"].'</td>  
                               <td>'.$row["potencia_3"].'</td>
                               <td>'.$row["funcionalidade_3"].'</td>
                               <td>'.$row["contato3"].'</td>
                               <td>'.$row["data_contato3"].'</td>
                               <td>'.$row["obs_contato3"].'</td>

                               <td>'.$row["atendeu_4"].'</td>  
                               <td>'.$row["potencia_4"].'</td>
                               <td>'.$row["funcionalidade_4"].'</td>
                               <td>'.$row["contato4"].'</td>
