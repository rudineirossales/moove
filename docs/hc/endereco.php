<?php 
         ...
         if(!isset($_SESSION["login"]) &&  !isset($_SESSION["senha"]) )
            ...
            {
              $query ="SELECT * FROM endereco where  status is null or  status = '' "; 
            }
            else
            {
              $query ="SELECT * FROM endereco where coordenador_campo = '".$_SESSION['nome']."' and status is null or coordenador_campo = '".$_SESSION['nome']."' and status = '' "; 
            }
...
function fnExcelReport() {
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Endereço Ofensores</h1>
          ...
          <div class="table-responsive">  
                     <table id="myTable" class="table table-striped table-bordered">  
                          ...
                          {  
                               echo '  
                               <tr>  
                                    <td><a href="envia_endereco.php?protocolo='.$row["protocolo"].'"> '.$row["protocolo"].' </span></a></td>   
                                    <td>'.$row["uf"].'</td>
                                    <td>'.$row["endereco"].'</td> 
                                    <td>'.$row["setor"].'</td> 
