    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="tile">
          <form class="form-inline" role="form"   method="POST" action="pesq_endereco.php" style="margin-left:10%;">
                     ...
                     <table id="myTable" class="table table-striped table-bordered">  
                          ...
                          <?php  
                            ...
                            $data2 = $_POST['date2'];
                              ...
                              $query ="select *  from endereco  where data_referencia BETWEEN '$data' and  '$data2' and status = 'JUSTIFICADO'";
                          ...
                          {     
                               ...
                               <td><a style='padding-left:25%;' target=”_blank” href='pdf_endereco.php?protocolo=<?php echo $protocolo; ?>'><i class='icon fa fa-folder-open-o'></i></a></td>
