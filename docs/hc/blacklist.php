<?php 
         ...
         if(!isset($_SESSION["login"]) &&  !isset($_SESSION["senha"]) )
            ...
            {
              $query ="SELECT * FROM blacklist where coordenador_campo = '".$_SESSION['nome']."' and status is null or coordenador_campo = '".$_SESSION['nome']."' and status = '' "; 
            }
...
function fnExcelReport() {
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Justifica Blacklist</h1>
          ...
          <div class="table-responsive">  
                     <table id="myTable" class="table table-striped table-bordered">  
                          ...
                          {  
                               echo '  
                               <tr>  
                                    <td><a href="envia_blacklist.php?sa='.$row["sa"].'"> '.$row["sa"].' </span></a></td>   
                                    <td>'.$row["gpon"].'</td>
                                    <td>'.$row["data"].'</td>
                                    <td>'.$row["dias"].'</td>  
                                    <td>'.$row["tecnico"].'</td> 
