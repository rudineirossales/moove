    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="tile">
          <form class="form-inline" role="form"   method="POST" action="pesq_blacklist.php" style="margin-left:10%;">
                     ...
                     <table id="myTable" class="table table-striped table-bordered">  
                          ...
                          <?php  
                            ...
                            $data2 = $_POST['date2'];
                              ...
                              $query ="select *  from blacklist  where data_referencia BETWEEN '$data' and  '$data2' and status = 'JUSTIFICADO'";
                          ...
                          {     
                               ...
                               <td>'.$row["data"].'</td> 
                               <td>'.$row["dias"].'</td>  
                               <td>'.$row["faixa_de_dias"].'</td>  
                               <td>'.$row["link_quality"].'</td> 
                               <td>'.$row["optical_signal"].'</td>
                               <td>'.$row["tecnico"].'</td>
                             ]
                               <td>'.$row["coordenador_campo"].' ';?> </td> 
                               
                              
                               <td><a style='padding-left:25%;' target=”_blank” href='pdf_blacklist.php?sa=<?php echo $sa; ?>'><i class='icon fa fa-folder-open-o'></i></a></td>
