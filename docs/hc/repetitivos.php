<?php 
         ...
         if(!isset($_SESSION["login"]) &&  !isset($_SESSION["senha"]) )
            ...
            {
              $query ="SELECT * FROM repetitivos where  status is null or  status = '' "; 
            }
            else
            {
              $query ="SELECT * FROM repetitivos where hierarquia_gestor = '".$_SESSION['nome']."' and status is null or hierarquia_gestor = '".$_SESSION['nome']."' and status = '' "; 
            }
...
function fnExcelReport() {
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Repetitivos pendentes</h1>
                     ...
                     <table id="myTable" class="table table-striped table-bordered">  
                          <thead>  
                               <tr>  
                                    ...
                                    <td>Matrícula</td>  
                                    <td>Nome</td> 
                                    <td>Cód. Encerramento</td>
                                    <td>Cód. Macro</td>
                                    <td>Cód. Descrição</td>
                                    <td>Fsloi. Gpon</td>
                                    <td>Repetidos críticos</td>
                                    <td>Qtd. repetidos</td>
                                    <td>Setor</td>
                          ...
                          {  
                               echo '  
                               <tr>  
                                    <td><a href="envia_repetitivos.php?sa='.$row["sa"].'"> '.$row["sa"].' </span></a></td>   
                                    <td>'.$row["uf"].'</td>
