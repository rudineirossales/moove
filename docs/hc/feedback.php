<?php 
         ...
         if(!isset($_SESSION["login"]) &&  !isset($_SESSION["senha"]) )
            ...
            {
              $query ="SELECT * FROM feedback where  status is null or  status = '' "; 
            }
            else
            {-
              $query ="SELECT * FROM feedback where coordenador_campo = '".$_SESSION['nome']."' and status is null or coordenador_campo = '".$_SESSION['nome']."' and status = '' "; 
            }
          ...
          <div class="table-responsive">  
                     <table id="myTable" class="table table-striped table-bordered">  
                          ...
                          {  
                               echo '  
                               <tr>  
                                    <td><a href="envia_feedback.php?chave='.$row["chave"].'"> '.$row["chave"].' </span></a></td>   
                                    
                                    <td style="min-width: 300px;" >'.$row["coordenador_campo"].'</td>
                                    <td style="min-width: 300px;" >'.$row["nome"].'</td>  
                                    <td>'.$row["indicador"].'</td>
                                    <td style="min-width: 300px;">'.$row["causa"].'</td>
