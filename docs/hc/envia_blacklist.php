<?php 
         ...
         if(!isset($_SESSION["login"]) &&  !isset($_SESSION["senha"]))
            ...
            $sql = mysql_query ("select * from blacklist where sa = '$sa'" );
            ...
            $row = mysql_num_rows($sql);
...

                {
                    while ($dado = mysql_fetch_assoc($sql))
                    {
                        ...
                        $data = $dado["data"];
                        $link_quality = $dado["link_quality"];
                        $optical_signal = $dado["optical_signal"];
                        $dias = $dado["dias"];
                        $faixa_de_dias = $dado["faixa_de_dias"];
      ...
      <div class="row justify-content-md-center">
        <div class="col-md-6">
          <div class="tile">
            <div class="row">
              <div class="col-lg-12">
                <form method="post"  action="registra_blacklist.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control"  id="ba" readonly name="ba_comun" value="<?php echo $no_logradouro?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Fachada</label>
                    <input class="form-control"  id="ba" readonly name="uf"  value="<?php echo $nu_fachada?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control"  id="ba" readonly name="estacao"  value="<?php echo $data?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control"  id="ba" readonly name="estacao"  value="<?php echo $link_quality?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Sinal Optico</label>
                    <input class="form-control"  id="ba" readonly name="estacao"  value="<?php echo $optical_signal?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Dias</label>
                    <input class="form-control"  id="ba" readonly name="estacao"  value="<?php echo $dias?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Faixa de dias </label>
                    <input class="form-control"  id="ba" readonly name="estacao"  value="<?php echo $faixa_de_dias?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Técnico</label>
                    <input class="form-control"  id="ba" readonly name="estacao"  value="<?php echo $tecnico?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Coordenador</label>
                    <input class="form-control"  id="ba" readonly name="estacao"  value="<?php echo $coordenador_campo?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  ...
                  <div class="form-group">
                        ...
                        <input class="form-control" required type="file" accept=".png,.jpg,.jpeg" id="upload_file2" onchange="getImagePreview2(event)" name="foto_ont" >
                        <div id="preview2"> </div>
                        <label for="formFile" class="form-label" style="font-size:11px;color:red;">*Tamanho máximo da imagem 2MB* </label>
