...
function fnExcelReport() {
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Pesquisa de repetitivos justificados</h1>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="tile">
          <form class="form-inline" role="form"   method="POST" action="pesq_repetitivos.php" style="margin-left:10%;">
          ...
          <div class="table-responsive">  
                     <table id="myTable" class="table table-striped table-bordered">  
                          <thead>  
                               <tr> 
                                    <td>Sa</td>  
                                    <td>Fim da execucação</td> 
                                    <td>Matrícula</td>  
                                    <td>Nome</td> 
                                    <td>Cód</td> 
                                    <td>Cód macro</td>
                                    <td>Cód descrição curta</td>
                                    <td>Gestor</td>
                                    <td>Gpon</td>
                                    <td>Reparos críticos</td>
                                    <td>Qtd. de repetições</td>
                                    <td>Setor</td>
                                    <td>Pdf</td>
                          ...
                          <?php  
                            ...
                            $data2 = $_POST['date2'];
                              ...
                              $query ="select *  from repetitivos  where data_referencia BETWEEN '$data' and  '$data2' and status = 'JUSTIFICADO'";
                          ...
                          {     
                               ...
                               <tr> 
                               <td>'.$row["sa"].'</td>
                               <td>'.$row["fim_execucao"].'</td> 
                               <td>'.$row["matricula"].'</td>  
                               <td>'.$row["nome"].'</td>  
                               <td>'.$row["cod"].'</td> 
                               <td>'.$row["cod_encerramento_macro"].'</td>
                               <td>'.$row["cod_desc_curta"].'</td>
                               <td>'.$row["hierarquia_gestor"].'</td>
                               <td>'.$row["fsloi_gpon"].'</td>
                               <td>'.$row["reparos_criticos"].'</td>
                               <td>'.$row["qtd_repeticoes"].'</td>
                               
                               
                               <td>'.$row["setor"].' ';?> </td> 
                               
                              
                               <td><a style='padding-left:25%;' target=”_blank” href='pdf_repetitivos.php?sa=<?php echo $sa; ?>'><i class='icon fa fa-folder-open-o'></i></a></td>
