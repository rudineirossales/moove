    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="tile">
          <form class="form-inline" role="form"   method="POST" action="pesq_feedback.php" style="margin-left:10%;">
                     ...
                     <table id="myTable" class="table table-striped table-bordered">  
                          ...
                          <?php  
                            ...
                            $data2 = $_POST['date2'];
                              ...
                              $query ="select *  from feedback  where data_referencia BETWEEN '$data' and  '$data2' and status = 'JUSTIFICADO'";
                          ...
                          {     
                               ...
                               <td><a style='padding-left:25%;' target=”_blank” href='pdf_feedback.php?matricula=<?php echo $matricula; ?>'><i class='icon fa fa-folder-open-o'></i></a></td>
