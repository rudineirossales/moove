...
function fnExcelReport() {
    ...
    tab_text = tab_text + '<head><xml><x:ExcelWorkbook><x:ExcelWorksheets><x:ExcelWorksheet>';da
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Pesquisa de pós reparos encerrados</h1>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="tile">
          <form class="form-inline" role="form"   method="POST" action="pesq_posreparo.php" style="margin-left:10%;">
          ...
          <div class="table-responsive">  
                     <table id="myTable" class="table table-striped table-bordered">  
                          ...
                          <?php  
                           ...
                           $query ="select *  from reparo_hc where data_execucao BETWEEN '$data' and '$data2' and tratada = 'S'";
                          ...
                          {     
                               ...
                               <td><a style='padding-left:25%;' target=”_blank”  href='pdf_posreparo.php?sa=<?php echo $sa; ?>'><i class='icon fa fa-folder-open-o'></i></a></td>
