...
{
	setTimeout("window.location='blacklist.php'");
...
$foto_rat  =$_POST['foto_rat'];
        ...
        $query ="update blacklist set resultado_auditoria = '$descricao', causa_reparo = '$causareparo', data_cadastro ='$hoje', foto_potencia = '$novo_nome1', foto_ont = '$novo_nome2', foto_velocidade = '$novo_nome3', foto_rat = '$novo_nome4', status='JUSTIFICADO' where sa = '$sa'";
