...
{
	setTimeout("window.location='garantia.php'");
...
$tec_anterior  =$_POST['tec_anterior'];
$endereco  =$_POST['endereco'];
$numero  =$_POST['numero'];
$coordenador_campo  =$_POST['coordenador_campo'];
$ag_hoje  =$_POST['ag_hoje'];
$dias  =$_POST['dias'];
$matricula_atual  =$_POST['matricula_atual'];
$tecnico_atual  =$_POST['tecnico_atual'];
...
$foto_rat  =$_POST['foto_rat'];
        ...
        $query ="update garantia set resultado_auditoria = '$descricao', causa_reparo = '$causareparo', data_cadastro ='$hoje', foto_potencia = '$novo_nome1', foto_ont = '$novo_nome2', foto_velocidade = '$novo_nome3', foto_rat = '$novo_nome4', status='JUSTIFICADO' where sa_reparo = '$sa'";
