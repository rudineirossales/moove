<?php 
         ...
         if(!isset($_SESSION["login"]) &&  !isset($_SESSION["senha"]))
            ...
            $sql = mysql_query ("select * from garantia where sa_reparo = '$sa'" );
            ...
            $row = mysql_num_rows($sql);
...

                {
                    while ($dado = mysql_fetch_assoc($sql))
                    {
                        ...
                        $sa_anterior = $dado["sa_anterior"];
                        $id_companhia = $dado["id_companhia"];
                        $matricula = $dado["matricula"];
                        $tec_anterior = $dado["tec_anterior"];
                        $endereco = $dado["endereco"];
                        $numero = $dado["numero"];
                        $complemento = $dado["complemento"];
                        $coordenador_campo = $dado["coordenador_campo"];
                        $coordenador_area = $dado["coordenador_area"];
                        $ag_hoje = $dado["ag_hoje"];
                        $sa_reparo = $dado["sa_reparo"];
                        $dias = $dado["dias"];
                        $matricula_atual = $dado["matricula_atual"];
                        $tecnico_atual = $dado["tecnico_atual"];
                        $tecnico_atual = $dado["tecnico_atual"];
                    }
      ...
      <div class="row justify-content-md-center">
        <div class="col-md-6">
          <div class="tile">
            <div class="row">
              <div class="col-lg-12">
                <form method="post"  action="registra_garantia.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control"  id="ba" readonly name="id_companhia" value="<?php echo $id_companhia?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Técmico anterior</label>
                    <input class="form-control"  id="ba" readonly name="tec_anterior"  value="<?php echo $tec_anterior?>" type="text" aria-describedby="emailHelp" >
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Endereço</label>
                    <input class="form-control"  id="ba" readonly name="endereco"  value="<?php echo $endereco?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Número</label>
                    <input class="form-control"  id="ba" readonly name="numero"  value="<?php echo $numero?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Coordenador</label>
                    <input class="form-control"  id="ba" readonly name="coordenador_campo"  value="<?php echo $coordenador_campo?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Ag. hoje</label>
                    <input class="form-control"  id="ba" readonly name="ag_hoje"  value="<?php echo $ag_hoje?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Dias</label>
                    <input class="form-control"  id="ba" readonly name="dias"  value="<?php echo $dias?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Matrícula atual</label>
                    <input class="form-control"  id="ba" readonly name="matricula_atual"  value="<?php echo $matricula_atual?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Técnico atual</label>
                    <input class="form-control"  id="ba" readonly name="tecnico_atual"  value="<?php echo $tecnico_atual?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  ...
                  <div class="form-group">
                        ...
                        <input class="form-control" type="file" accept=".png,.jpg,.jpeg" id="upload_file" onchange="getImagePreview(event)" name="foto_potencia" >
                        <div id="preview"> </div>
                  ...
                  <div class="form-group">
                        ...
                        <input class="form-control" type="file" accept=".png,.jpg,.jpeg" id="upload_file2" onchange="getImagePreview2(event)" name="foto_ont" >
                        <div id="preview2"> </div>
                        <label for="formFile" class="form-label" style="font-size:11px;color:red;">*Tamanho máximo da imagem 2MB* </label>
                  ...
                  <div class="form-group">
                        ...
                        <input class="form-control" type="file" accept=".png,.jpg,.jpeg" id="upload_file3" onchange="getImagePreview3(event)" name="foto_velocidade" >
                        <div id="preview3"> </div>
                        <label for="formFile" class="form-label" style="font-size:11px;color:red;">*Tamanho máximo da imagem 2MB* </label>
                  ...
                  <div class="form-group">
                        ...
                        <input class="form-control" type="file" accept=".png,.jpg,.jpeg" id="upload_file4" onchange="getImagePreview4(event)" name="foto_rat" >
                        <div id="preview4"> </div>
                        <label for="formFile" class="form-label" style="font-size:11px;color:red;">*Tamanho máximo da imagem 2MB* </label>
