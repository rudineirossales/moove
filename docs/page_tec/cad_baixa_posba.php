...
<script type="text/javascript" src="js/jquery-ui.js"></script>
  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item active"  <?php if ($_SESSION["acesso"] == "Tec"){ echo 'href="page_preventivas.php"';} else {echo 'href="page_preventivas.php"'; } ?>><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Dashboard</span></a></li>
          ...
          <div class="tile">
            <div class="row">
              <div class="col-lg-12">
                ...
                <form onSubmit="if(!confirm('Deseja encerrar a atividade???')){return false;}" method="post"  enctype="multipart/form-data" action="enviar_cad_baixa_posba.php">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control"  id="ba" readonly   value="<?php echo $endereco?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Causa</label>
                    <input class="form-control"  id="ba" readonly   value="<?php echo $causa?>" type="text" aria-describedby="emailHelp" >
                  </div>
                <div class="form-group">
