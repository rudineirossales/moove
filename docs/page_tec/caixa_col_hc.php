<?php 
         ...
         if(!isset($_SESSION["login"]) &&  !isset($_SESSION["senha"]) )
            ...
            $query ="SELECT * FROM reparo_hc WHERE status = 'EM ANDAMENTO' and id_usu = '".$_SESSION["id"]."'";
...
<html lang="en">
  <head>
  <title>Caixa do colaborador.</title>  
          ...
          <div class="table-responsive">  
                     <table id="myTable" class="table table-striped table-bordered">  
                          ...
                          {  
                               echo '  
                               <tr>  
                                    <td><a href="cad_baixa_hc.php?sa='.$row["sa"].'"> '.$row["sa"].' </span></a></td>   
                                    <td>'.$row["uf"].'</td>
                                    <td>'.$row["status"].'</td>
                                    <td>'.$row["tecnico"].'</td>
