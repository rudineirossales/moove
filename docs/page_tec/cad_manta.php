...
<script type="text/javascript" src="js/jquery-ui.js"></script>
  ...
  <body class="app sidebar-mini rtl"  onLoad="getLocation()">
    ...
    <main class="app-content"> 
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Cadastro de mantas</h1>
          <p></p>
        </div>
          ...
          <div class="tile">
            <div class="row">
              <div class="col-lg-12">
                ...
                <form onSubmit="if(!confirm('Deseja encerrar a atividade???')){return false;}" method="post"  enctype="multipart/form-data" action="enviar_cad_mantas.php">

                
                  <div class="form-group">
                    <label for="email">Uf</label>  
                        <select class="form-control " id="mySelect" name="uf">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control"  id="ba"  required name="bairro"  type="text" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group">
                    <label for="email">Tipo de aplicação</label>  
                        <select class="form-control " id="mySelect" name="tipo_aplicacao">
                            <option value="Subida lateral">  Subida lateral </option>
                            <option value="Aereo">  Aereo </option>
                        </select>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Estação e cabo</label>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Quantidade de mantas</label>
                    <input class="form-control"  id="ba"  required name="qtd_mantas"   type="number" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Quantidade de espiral</label>
                    <input class="form-control"  id="ba"  required name="qtd_espiral"   type="number" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                        ...
                        <input class="form-control" required type="file" accept=".png,.jpg"  name="teste1" id="upload_file" onchange="getImagePreview(event)" >
                        <div id="preview"> </div>
    ...
    <div class="form-group">
                        ...
                        <input class="form-control" required type="file" accept=".png,.jpg"  name="teste2" id="upload_file2" onchange="getImagePreview2(event)">
                        <div id="preview2"> </div>
                        <label for="formFile" class="form-label" style="font-size:11px;color:red;">*OBRIGATÓRIO* </label>
