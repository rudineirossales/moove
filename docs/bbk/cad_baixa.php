...
{
	setTimeout("window.location='dashboard_bbk.php'");
...
<script type="text/javascript" src="js/jquery-ui.js"></script>
  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item active"  <?php if ($_SESSION["acesso"] == "Tec"){ echo 'href="index_col.html"';} else {echo 'href="dashboard_bbk.php"'; } ?>><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Dashboard</span></a></li>
             ...
             <div class="col-lg-12">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control"  id="ba" readonly name="estacao"  value="<?php echo $estacao_a?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control"  id="ba" readonly name="tipo"  value="<?php echo $cliente?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group"> 
                    <label for="exampleInputEmail1">Ccto</label>
                    <input class="form-control"  id="ba" readonly name="tipo"  value="<?php echo $ccto?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">PRS</label>
                    <input class="form-control"  id="ba" readonly name="tipo"  value="<?php echo $prs?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Barramento</label>
                    <input class="form-control"  id="ba" readonly name="tipo"  value="<?php echo $barramento?>" type="text" aria-describedby="emailHelp" >
                  </div>
