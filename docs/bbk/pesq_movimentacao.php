          ...
          <div class="table-responsive">  
                     <table id="myTable" class="table table-striped table-bordered">  
                          ...
                          <?php  
                            ...
                            $query ="select *  from usuario join atividade_bbk on usuario.id = atividade_bbk.id_usu  where data_encerramento BETWEEN '$data 00:00:00' and '$data2 23:59:00' and status='ENCERRADO' and id_usu = '".$_SESSION["id"]."'";  
                            }
                            else
                            {
                            $query ="select *  from usuario join atividade_bbk on usuario.id = atividade_bbk.id_usu  where data_encerramento BETWEEN '$data 00:00:00' and '$data2 23:59:00' and status='ENCERRADO' ";
                            }
