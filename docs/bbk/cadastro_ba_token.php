...
<?php 
         ...
         if(!isset($_SESSION["login"]) &&  !isset($_SESSION["senha"])  || ($_SESSION["acesso"] != 'BBK' ) )
            {
...
<html lang="en">
  ...
  <script type="text/javascript">
        ...
        $(document).ready(function(){
           ...
           $("select[name=tec]").change(function(){
              $("select[name=coord]").html('<option value="0">Carregando...</option>');
               
              $.post("Tecnicos.php",
                    {tec:$(this).val()},
                    function(valor){
                       $("select[name=coord]").html(valor);
                    }
                    )
      })
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
                ...
                <form class="form-inline" role="form"   method="POST" action="cadastro_ba_token.php">
      ...
      <div class="row justify-content-md-center" >
        <div class="col-md-6">
          ...
          <div class="col-lg-12">
            ...
            <div class="bs-component">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade active show" id="home">
                     <form onSubmit="if(!confirm('Deseja repassar atividade??')){return false;}" method="post" enctype="multipart/form-data" action="enviar_cadastro_token.php">
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control"  id="ba" readonly   name="estacao_a" value="<?php echo $estacao_a?>" type="text" aria-describedby="emailHelp" >
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control"  id="ba" readonly  name="coord" value="<?php echo $nome_gestor?>" type="text" aria-describedby="emailHelp" >
                  </div>
           ...
           <legend class="w-auto px-1" style="font-size: 12px;">Equipe Auxiliar</legend>
                <div class="form-group">
                <label for="exampleSelect1">Técnico </label>
                                  ...
                                  <option value=""  checked >Escolha um Técnico </option>
                                        ...
                                        $sql = "SELECT * FROM usuario where funcao = 'Tec_bbk' order by nome
                                        ";
...
<?php if (isset($ba2) && $status <> "ENCERRADO" && $status <> "PARALISADO" )
