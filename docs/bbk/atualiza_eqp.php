              ...
              <div class="col-lg-12">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                                          <label for="exampleSelect1">Id Coordenador</label>
                                          <select readonly  class="form-control" id="tec" name="tec" required >
                  ...
                  <div class="form-group">
                        ...
                        <select class="form-control " id="mySelect" name="status">
                            ...
                            <option value="VEICULO QUEBRADO">  VEÍCULO QUEBRADO </option>
                            <option value="SUSPENSAO">  SUSPENSÃO </option>
                            <option value="MANUTENCAO FERRAMENTAL">  MANUTENÇÃO FERRAMENTAL </option>
