          ...
          <div class="table-responsive">  
                     <table id="myTable" class="table table-striped table-bordered">  
                          ...
                          <?php  
                             ...
                             $query ="select * from atividade_bbk join usuario on atividade_bbk.id_usu = usuario.id where status <> 'ENCERRADO' and status <> 'EM VALIDACAO' and status <> 'PARALISADO' and atividade_bbk.nome_gestor = '".$_SESSION['nome']."' and status <> 'DESPCOORD' GROUP BY id_usu;";  
