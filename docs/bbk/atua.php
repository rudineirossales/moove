...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="dashboard_bbk.php">Icomon</a><br>
            ...
            <div class="bs-component">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade active show" id="home">
                     <form onSubmit="if(!confirm('Deseja repassar atividade??')){return false;}" method="post" enctype="multipart/form-data" action="enviar_atua.php">
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control"  id="ba" readonly   value="<?php echo $estacao_a?>" type="text" aria-describedby="emailHelp" >
                  </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control"  id="ba" readonly   value="<?php echo $status?>" type="text" aria-describedby="emailHelp" >
                  </div>
