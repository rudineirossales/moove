<?php 
         ...
         if(!isset($_SESSION["login"]) &&  !isset($_SESSION["senha"]) )
            ...
            $query ="select cadastro_status,protocolo,logradouro,num_fachada,comp1,comp2,comp3,cod_survey from projeto where cod_logradouro = '$cod' and cadastro_status = 'EXCLUIDO'  order by num_fachada ";  
