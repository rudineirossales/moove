<?php 
         ...
         if(!isset($_SESSION["login"]) &&  !isset($_SESSION["senha"]) )
            ...
            $query ="select trava,trava_por,cadastro_status,protocolo,logradouro,num_fachada,comp1,comp2,comp3,cod_survey from projeto where cod_logradouro = '$cod' and cadastro_status = 'NAO INICIADO' or cadastro_status = 'PENDENTE' or cadastro_status = 'CONCLUIDO' order by num_fachada ";  
