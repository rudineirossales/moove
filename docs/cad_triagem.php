...
{
	setTimeout("window.location='pesq_triagem.php'");
      ...
      <div class="row justify-content-md-center">
        <div class="col-md-6">
          <div class="tile">
            <div class="row">
              <div class="col-lg-12">
                <form method="post"  onSubmit="if(!confirm('Deseja modificar atividade?')){return false;}" action="cad_triagem.php ">
                ...
                <textarea class="form-control" rows="5" readonly id="obs" name="obs" maxlength="20000" placeholder="Máximo 2000 caracteres"> <?php echo $obs_cl; ?> </textarea>
                  ...
                  <div class="form-group">
                    ...
                    <option value="0" checked  >Escolha um coordenador</option>
                  ...
                  <button class="btn btn-danger" style="float:right;" name="submit2" type="submit">Encerrar</button>
  ...
  $row = mysql_num_rows($sql2);
...

    {
      ...
      $gestor = $dado["nome"];
          ...
          $query = "update atividade set id_usu = '$id_gestor', nome_gestor = '$gestor', status = 'DESPCOORD' where ba = '$ba'";
...
if (isset($_POST ['submit2']) )
{
        ...
        if($sql)
        {
          ...
          echo "
          <script language='JavaScript'>
          window.alert('ENCERRADA COM SUCESSO!')
