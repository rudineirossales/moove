...
$tabelaAtividade = 'atividade_bbk'; // Nome da tabela "atividade"
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sqlMaterial = "INSERT INTO $tabelaMaterial (ba, descricao, quantidade, data) VALUES (?, ?, ?, ?)";
    ...
    if ($stmtMaterial) {
        ...
        $stmtMaterial->bind_param("ssis", $ba, $descricao, $quantidade, $dataHoraAtual);
            ...
            if ($stmtAtividade) {
                ...
                if ($stmtAtividade->num_rows > 0) {
                    ...
                    if ($stmtLogs) {
                        ...
                        $stmtLogs->bind_param("sisi", $ba, $status, $id_usu, $dataHoraAtual);
                        $stmtLogs->execute();
