...
$sql = "SELECT * FROM atividade WHERE id_usu = '$loggedInUser' and status <> 'ENCERRADO' and status <> 'PARALIZADO' and status <> 'EM ANDAMENTO' and status <> 'EM VALIDACAO' and status <> 'BA APOIO'";
