...
$host = '62.72.63.187'; // Endereço do servidor do banco de dados
$usuario = 'remoteicomon'; // Usuário do banco de dados
$senha = 'Rud!n3!@'; // Senha do banco de dados
$bancoDados = 'icomon'; // Nome do banco de dados
...
// Verificar se a requisição é do tipo POSTs
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sqlMaterial = "INSERT INTO $tabelaMaterial (ba, descricao, quantidade, data) VALUES (?, ?, ?, '$dataHoraAtual')";
