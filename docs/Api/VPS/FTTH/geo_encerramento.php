...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $checkQuery = "SELECT * FROM atividade WHERE ba = '$ba'";
    $result = $conn->query($checkQuery);

    if ($result->num_rows > 0) {
        // Atualize o registro existente com as novas coordenadas
        $updateQuery = "UPDATE atividade SET latitude_final = '$latitude_final', longitude_final = '$longitude_final' WHERE ba = '$ba'";
        ...
        $insertQuery = "INSERT INTO atividade (ba, latitude_final, longitude_final)
