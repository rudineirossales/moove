...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE atividade_bbk SET status = 'EM ANDAMENTO', latitude = '$latitude', longitude = '$longitude', checkBox = '$checkBox', checkBox2 = '$checkBox2', data_atribuicao = '$hoje' WHERE ba = '$ba'";
