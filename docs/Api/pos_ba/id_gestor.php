...
// Query preparada para buscar o nome do gestor com base no ID
$query = "SELECT nome FROM usuario WHERE id = '$idGestor'";
...
if ($stmt->execute()) {
    ...
    // Caso ocorra um erro na execução da consulta preparada
    echo json_encode(array('message' => 'Erro na consulta preparada'));
}
