...
function fnExcelReport() {
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Pesquisa de materiais (por período)</h1>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="tile">
          <form class="form-inline" role="form"   method="POST" action="pesq_movimentacao_materiais.php" style="margin-left:10%;">
          ...
          <div class="table-responsive">  
                     <table id="myTable" class="table table-striped table-bordered">  
                          ...
                          <?php  
                            ...
                            $query ="select *  from material where data BETWEEN '$data 00:00:00' and '$data2 23:59:00' order by data desc";  
                          ...
                          {     
                               ...
                               <td>'.$row["data"].' ';?> </td>
                               <td><a style='padding-left:25%;' target="_blank" href='pdf.php?ba=<?php echo $ba; ?>'><i class='icon fa fa-folder-open-o'></i></a></td> 
