    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="tile">
          <form class="form-inline" role="form"   method="POST" action="pesq_preventiva_contratual_encerrada.php" style="margin-left:10%;">
          ...
          <div class="table-responsive">  
                     <table id="myTable" class="table table-striped table-bordered">  
                          ...
                          <?php  
                           ...
                           <a target="_blank" href='pdf_geral_preventiva.php?data=<?php echo $data ?>&data2=<?php echo $data2 ?>'><i class='icon fa fa-folder-open-o'></i> Download Pdf Geral </a><br><br>

                           <?php
                             $query ="select *  from preventiva_contratual  where data_referencia BETWEEN '$data' and '$data2' and status = 'CONCLUIDO'"; 
                          ...
                          {     
                               ...
                               <td><a style='padding-left:25%;' target="_blank" href='pdf_preventiva.php?ba=<?php echo $ba; ?>'><i class='icon fa fa-folder-open-o'></i></a></td>
