...
<script type="text/javascript" src="js/jquery-ui.js"></script>
  ...
  <body class="app sidebar-mini rtl">
    ...
    <div class="form-group">
          <label for="pwd">CÉLULA:</label>
          <input type="text" class="form-control"  name="celula" required>
    </div>

    <div class="form-group">
          <label for="pwd">CDOE CDOIA:</label>
          <input type="text" class="form-control"  name="cdoe_cdoia" required>
    </div>
    ...
    <div class="form-group" id="inputOculto2">
      <div class="form-check">
                        <input class="form-check-input" type="radio" name="opc2" value="ND" id="flexRadioDefault4" checked >
                        <label class="form-check-label" for="flexRadioDefault2" >
                         ND
                        </label>
      </div>
      <div class="form-check">
                        <input class="form-check-input" type="radio" name="opc2" value="ICOMON" id="flexRadioDefault5"  >
                        <label class="form-check-label" for="flexRadioDefault2" >
                         ICOMON
                        </label>
      </div>
      <div class="form-check">
                        <input class="form-check-input" type="radio" name="opc2" value="VTAL" id="flexRadioDefault6"  >
                        <label class="form-check-label" for="flexRadioDefault2" >
                         VTAL
                        </label>
      </div>
      <div class="form-check">
                        <input class="form-check-input" type="radio" name="opc2" value="SEREDE" id="flexRadioDefault7"  >
                        <label class="form-check-label" for="flexRadioDefault2" >
                         SEREDE
                        </label>
      </div>
    ...
    <div class="form-group">
     <label for="email">TIPO DE REDE:</label>  
        <select class="form-control "  name="tipo_rede">
