...
$select = mysql_query ("select * from preventivass WHERE data between '$data' and '$data2' ");
...
<span>DATA:  $linha[data]   </span><br>
    ...
    <tr>
    <td> <img src='../Api/VPS/PREVENTIVAS/Preventivas/$linha[foto_antes]' width='300' height='300'><br> Foto antes CL</td>
    <td> <img src='../Api/VPS/PREVENTIVAS/Preventivas/$linha[foto_depois]' width='300' height='300'><br> Foto depois </td>
    <td> <img src='../Api/VPS/PREVENTIVAS/Preventivas/$linha[foto1]' width='300' height='300'><br> Foto antes CL</td>
    <td> <img src='../Api/VPS/PREVENTIVAS/Preventivas/$linha[foto2]' width='300' height='300'><br> Foto depois </td>
