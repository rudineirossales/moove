...
function fnExcelReport() {
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Pesquisa de Preventivas</h1>
                     ...
                     <table id="myTable" class="table table-striped table-bordered">  
                          <thead>  
                               <tr> 
                                    ...
                                    <td>Travessiaa</td>
                                    <td>Cdoe</td>
                                    <td>Lancamento de cabo</td>
                                    <td>Capacidade do cabo</td>
                                    <td>Duto lateral</td>
                                    <td>Instalacao de poste</td>
                                    <td>Remocao de poste</td>
                                    <td>Data</td>
                                    <td>Pdf</td>
                                    <td>Map</td>
                                   </tr>  
                          ...
                          <?php  
                           ...
                           <?php
                            ...
                            $query ="select *  from preventivass  where data BETWEEN '$data' and '$data2'";
                          ...
                          {     
                               ...
                               <td>'.$row["travessias_regularizadas"].'</td>  
                               <td>'.$row["cdoe_regularizada"].'</td>
                               <td>'.$row["lancamento_cabo"].'</td>
                               <td>'.$row["capacidade_cabo"].'</td>
                               <td>'.$row["duto_lateral"].'</td>
                               <td>'.$row["instalacao_poste"].'</td>
                               <td>'.$row["remocao_poste"].'</td>
                               <td>'.$row["data"].' ';?> </td> 
                               <td><a style='padding-left:25%;' target="_blank" href='pdf.php?protocolo=<?php echo $id; ?>'><i class='icon fa fa-folder-open-o'></i></a></td>
                               <td> <a href="https://www.google.com.br/maps/search/<?php echo $lat ?>,<?php echo  $long ?>/@<?php echo $lat ?>,<?php echo  $long  ?>" target="_blank"  role="button" aria-pressed="true"><i class='icon fa fa-map-marker'></i></a></td>
                               </tr>  
                               <?php
                          }  }
                          ?>  
